...
`design/new-design.pen` не участвует в работе. Эта карта является навигационным индексом для задач, ревью и агентского workflow; если карта расходится с `.pen`, каноническим источником считается `.pen`, а карту нужно обновить перед подготовкой frontend-задачи.
