...
Specs/tickets use the `to-spec → to-tickets` flow and live in `.scratch/<feature-slug>/`; details: `docs/agents/issue-tracker.md`.
Triage labels: `needs-triage`, `needs-info`, `ready-for-agent`, `ready-for-human`, `wontfix`; completed implementation awaiting review uses `awaiting-human-review`; details: `docs/agents/triage-labels.md`.
Domain docs: `CONTEXT.md` and `docs/adr/`; details: `docs/agents/domain.md`.
For `.pen`, pen.dev references, or visible frontend UI tasks, follow `docs/design/pen-ui-contract.md`.
